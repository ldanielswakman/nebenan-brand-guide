    ...
    return (
        <section className={`toc ${props.home ? 'toc--home' : ''}`}>
            ...
            <div className={`toc__section ${active === 'understanding' ? 'isActive' : ''}`}>
                <div role="button" tabIndex="-1" aria-label="Close menu" onClick={handleToggle('understanding')} onKeyDown={handleToggle('understanding')} className="toc__header">
            ...
            <div className={`toc__section ${active === 'using' ? 'isActive' : ''}`}>
                <div role="button" tabIndex="-1" aria-label="Close menu" onClick={handleToggle('using')} onKeyDown={handleToggle('using')} className="toc__header">
                    <div className="toc__icon">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
